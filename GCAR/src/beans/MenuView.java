		...
		public String verRelacion(){
			...
			if(bd == null){
				...
				context.addMessage(
						null,
						new FacesMessage(FacesMessage.SEVERITY_WARN,
								"No puedes ver ón si no has cargado una Base de Datos",
								""));
				context.getExternalContext().getFlash().setKeepMessages(true);
           		return "home";
			}else{
		...
		public String modificarRelacion(){
			...
			if(bd == null){
				...
				context.addMessage(
						null,
						new FacesMessage(FacesMessage.SEVERITY_WARN,
								"No puedes modificar ón si no has cargado una Base de Datos",
								""));
				context.getExternalContext().getFlash().setKeepMessages(true);
           		return "home";
			}else{
		...
		public String agregarRelacion(){
			...
			if(bd == null){
				...
				context.addMessage(
						null,
						new FacesMessage(FacesMessage.SEVERITY_WARN,
								"No puedes agregar ón si no has cargado una Base de Datos",
								""));
				context.getExternalContext().getFlash().setKeepMessages(true);
           		return "home";
			}else{
